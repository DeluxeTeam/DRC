...
public abstract class SublimeBaseMenuItem implements Parcelable {
    ...
    public enum ItemType {SEPARATOR, TEXT, CHECKBOX, SWITCH, BADGE, GROUP_HEADER, HEADER, CENTERED} //grx added centered type
    ...
    private static final String SS_PANTALLA = "ss.pantala";
