...
public class ColorPickerView extends View {
    ...
    //grx fix for some dialogs where we need smaller view (at least in some sammy devices)
    private float mScale=1f;

    public void setMeasureScale(float scale){
        mScale=scale;
    }
    //
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
     ...
     //   int heightMode = MeasureSpec.getMode(heightMeasureSpec);
        ...
        int widthMode = (int) ((float) MeasureSpec.getMode(widthMeasureSpec)*mScale);
        int heightMode = (int) ((float) MeasureSpec.getMode(heightMeasureSpec)*mScale);
